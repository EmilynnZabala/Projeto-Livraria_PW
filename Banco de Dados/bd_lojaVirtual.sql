...
inner join tbl_categoria
    ...
    CREATE USER"loja_virtual"@"localhost" IDENTIFIED WITH mysql_native_password BY'12345678';
    GRANT ALL PRIVILEGES ON db_loja_virtual. * TO 'loja_virtual'@'localhost' WITH GRANT OPTION;
